...
PERSISTED_T6_MEMNET_OFFLINE_PATH = 'saved_models/memnet_offline/t6_{ent}_{feats}/'
PERSISTED_T5_MEMNET_OFFLINE_PATH = 'saved_models/memnet_offline/t5_{ent}_{feats}/'
PERSISTED_LSTM_OFFLINE_PATH = 'saved_models/lstm_offline/t{task}_{ent}_{feats}/'
